...
SECRET_KEY = 'django-insecure-13zo8z$&trmj2t*()gwv$a^^)=fd1$x&kqk7y8ldmti=dto)w2'
...
# ckeditor
# CKEDITOR_BASEPATH = os.path.join(BASE_DIR, 'cdn', 'static', 'ckeditor', 'ckeditor')
# CKEDITOR_UPLOAD_PATH = os.path.join(BASE_DIR, 'cdn', 'media', 'ckeditor_uploads')
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': 'full',
        'height': 300,
...
STATIC_ROOT = os.path.join(BASE_DIR, 'cdn', 'statis')
